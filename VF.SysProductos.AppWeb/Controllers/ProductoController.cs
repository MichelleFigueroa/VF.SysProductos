...
namespace VF.SysProductos.AppWeb.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<JsonResult> ProductsJsonPrecio()
        {
            var productos = await _productoBL.ObtenerTodosAsync();
            ...
            var groupedData = productosData
                ...
                {
                    fecha = g.Key,
                    precio = g.Average(p => p.precio) // Calcular el precio promedio
                })
                .OrderBy(g => g.fecha)
                .ToList();
        ...
        public async Task<IActionResult> ReporteProductoExcel()
        {
            var productos = await _productoBL.ObtenerTodosAsync();

            // Agregar la configuración de licencia antes de usar ExcelPackage
            ...
            using (var package = new ExcelPackage())
            {
                ...
                hojaExcel.Cells["C1"].Value = "CantidadDisponible";
